...
def about_bot(message):
    bot.send_message(
        ...
        "Він генерує ідеї, тексти та допомагає з продажами.\n"
        "🚀 Побудований на базі OpenAI (ChatGPT)."
    )
...
def handle_inline_buttons(call):
    if call.data == "start_analysis":
        ...
        bot.send_message(call.message.chat.id, "📚 Сценарій для сторіс поки в розробці.")
